...
## About this instance of the web app

This welcome note was generated by an instance of the web app hosted at https://personalizedrefrigerator.github.io/joplin/web-client/.

The `personalizedrefrigerator.github.io` instance of the web app is used to test experimental changes and may be unstable. The official Joplin web app can be found at `app.joplincloud.com`.
