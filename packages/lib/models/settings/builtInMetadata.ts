...
const builtInMetadata = (Setting: typeof SettingType) => {
	...
	const output = {
		...
		'markdown.plugin.alerts': { storage: SettingStorage.File, isGlobal: true, value: true, type: SettingItemType.Bool, section: 'markdownPlugins', public: true, appTypes: [AppType.Mobile, AppType.Desktop], label: () => `${_('Enable markdown alerts')}${wysiwygYes}` },
